...
function Run()
{
    ...
    try
    {
        ...
        // историческим причинам (так был заведён изначально), но фактически в LPE он теперь
        // настроен как ссылка на "типовую должность" (common_position) и приходит как ID
        // position_common_id, а НЕ как текст названия должности -- поэтому читаем через OptInt,
        // не String.
