...
try
{
    ...
    switch (sSubmitType)
    {
        case "apply":
        {
            ...
            // ИЗМЕНЕНО (16.09.2026): city теперь настоящее поле формы -- читаем его как
            // остальные, через getFormField() (а не sDefaultCity напрямую), чтобы учесть,
            // если пользователь вручную поправил значение в модалке.
            sCity = String(getFormField("city", ""));
